import { ArrowBigRight, ArrowRight, ChevronFirstIcon, CircleChevronRight, Dot } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className=" p-4 w-full h-100 justify-center card-hover bg-primary rounded-lg">
            ...
            <ul className="h-full flex flex-col justify-center text-white">
                <li className="flex text-center">
                    <Dot /> 12 clases a la semana - $73.000
                </li>
            </ul>
          </div>
          <div className="p-4 w-full h-100 card-hover rounded-lg">
            ...
            <ul className="h-full flex flex-col justify-center text-center">
              <li className="flex"><Dot /> Lunes a Viernes - 6:30 hrs.</li>
              <li className="flex"><Dot /> Lunes a Viernes - 19:00 y 20:00 hrs.</li>
            </ul>
          </div>
        </div>
      </div>
