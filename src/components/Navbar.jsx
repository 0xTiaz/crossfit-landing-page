      ...
      <div className="container flex items-center justify-between">
        ...
        >
          <span className="relative z-10 flex items-center">
            <span className="text-foreground px-1"> Crossfit </span> Bullbox 365
          </span>
        </a>
          ...
          <div className="flex flex-col space-y-8 text-xl">
            {navItems.map((item, key) => (
              <a
                key={key}
                href={item.href}
                className="text-foreground/80 hover:text-primary font-bold transition-colors duration-300 text-2xl"
